...
@Autonomous(name = "BLUE DUCK Auto", group = "Autonomous Modes")
public class BlueDuckAutoOp extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory duck = drive.trajectoryBuilder(away_from.end())
                .lineToSplineHeading(new Pose2d(-62, 52, Math.toRadians(-270)))
                .build();
        ...
        double turn_angle = Math.toRadians(-97);
        double first = 30.5;
        double secondthird = 24;
